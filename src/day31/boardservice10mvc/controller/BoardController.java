package day31.boardservice10mvc.controller;

import day31.boardservice10mvc.model.BoardDao;
import day31.boardservice10mvc.model.BoardDto;
...
public class BoardController {
    ...
    public boolean boardDelete(int deleteNum) {
        ...
        // DAO에게 삭제할 번호를 전달하여 DB 처리 요청 후 결과 받기
